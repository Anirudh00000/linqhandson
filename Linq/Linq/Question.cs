...
namespace Linq
{
    internal class Question
    {
        ...
        {
            int[] numbers = new int[] { 1, 3, -2, -4, -7, -3, -8, 12, -19, 6, 10, 13};
        ...
        {
            string[] cities = new string[] { "ROME", "LUCKNOW", "NAIROBI", "CALCATA", "NEW DELHI", "AMSTERDAM", "ABU DHABI", "PARIS" ,"GORAKHPUR"};
        ...
        public void To_find_the_n_th_Maximum_grade_point_achieved_by_the_students_from_the_list_of_students(int n)
        {
            ...
            stulist.Add(new Student { StuId = 1, StuName = " Anirudh ", GrPoint = 800 });
            stulist.Add(new Student { StuId = 2, StuName = "rajan", GrPoint = 458 });
            stulist.Add(new Student { StuId = 3, StuName = "rajesh", GrPoint = 900 });
            stulist.Add(new Student { StuId = 4, StuName = "chandan", GrPoint = 900 });
